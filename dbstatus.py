...
'tb_boundary_studentcount':['select b2.id, c.gender, count(distinct s.id),count(distinct stu.id) from schools_student_studentgrouprelation stusg,schools_studentgroup sg,schools_student stu,schools_institution s,schools_boundary b,schools_boundary b1,schools_boundary b2, schools_child c where s.boundary_id=b.id and b.parent_id=b1.id and b1.parent_id=b2.id and s.active=2 and sg.institution_id=s.id and sg.active=2 and stusg.student_group_id=sg.id and stusg.active=2 and stusg.academic_id=122 and stusg.student_id=stu.id and stu.active=2 and stu.child_id = c.id group by b2.id,c.gender',
'select b1.id,c.gender, count(distinct s.id),count(distinct stu.id) from schools_student_studentgrouprelation stusg,schools_studentgroup sg,schools_student stu,schools_institution s,schools_boundary b,schools_boundary b1,schools_boundary b2,schools_child c where s.boundary_id=b.id and b.parent_id=b1.id and b1.parent_id=b2.id and s.active=2 and sg.institution_id=s.id and sg.active=2 and stusg.student_group_id=sg.id and stusg.active=2 and stusg.academic_id=122 and stusg.student_id=stu.id and stu.active=2 and stu.child_id = c.id group by b1.id,c.gender',
'select b.id,c.gender, count(distinct s.id),count(distinct stu.id) from schools_student_studentgrouprelation stusg,schools_studentgroup sg,schools_student stu,schools_institution s,schools_boundary b,schools_boundary b1,schools_boundary b2, schools_child c where s.boundary_id=b.id and b.parent_id=b1.id and b1.parent_id=b2.id and s.active=2 and sg.institution_id=s.id and sg.active=2 and stusg.student_group_id=sg.id and stusg.active=2 and stusg.academic_id=122 and stusg.student_id=stu.id and stu.active=2 and stu.child_id = c.id group by b.id,c.gender'],
...
'tb_schoolstudentcount':['select distinct s.id, c.gender, count(distinct stu.id) from schools_student_studentgrouprelation stusg,schools_studentgroup sg,schools_institution s,schools_student stu, schools_child c where stusg.student_id=stu.id and stu.active=2 and stusg.academic_id=122 and stusg.active=2 and stusg.student_group_id=sg.id and sg.active=2 and sg.institution_id=s.id and s.active=2 and s.child_id = c.id group by s.id,c.gender'],
'tb_classstudentcount':["select distinct sg.id,s.id,sg.name,sg.section, c.gender, count(distinct stu.id) from schools_student_studentgrouprelation stusg,schools_studentgroup sg,schools_institution s,schools_student stu, schools_child c where stusg.student_id=stu.id and stu.active=2 and stusg.academic_id=122 and stusg.active=2 and stusg.student_group_id=sg.id and sg.active=2 and sg.group_type='Class' and sg.institution_id=s.id and s.active=2 and s.child_id = c.id group by sg.id,s.id,sg.name,sg.section,c.gender"],
